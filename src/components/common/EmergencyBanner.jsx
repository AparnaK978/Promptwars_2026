...
import { Phone, ShieldAlert, HeartHandshake, AlertCircle } from 'lucide-react';
...
export function EmergencyBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-rose-950/90 via-slate-950 to-rose-950/90 border-b border-rose-900/40 px-4 py-2 text-xs sm:text-sm">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-rose-200 font-medium">
          <ShieldAlert className="h-4 w-4 text-rose-400 shrink-0" />
          <span>India Emergency Helplines (24/7 Confidential):</span>
        </div>
