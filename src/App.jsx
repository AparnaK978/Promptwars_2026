...
function AppContent() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${highContrast ? 'contrast-125 bg-black' : 'bg-slate-50'}`}>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-6 sm:py-8 mb-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          <div>
            ...
            <h1 className="text-2xl font-bold text-slate-900 font-display">
              {role === 'individual' ? (
                <span>Individual <span className="text-teal-600">Recovery Companion</span></span>
              ) : (
          ...
          <div className="space-y-6 animate-fadeIn">
            {cravingLogs.length === 0 && streakDays === 0 ? (
              ...
              <div className="healthcare-card p-8 text-center border border-slate-100 bg-white">
                <Sparkles className="h-10 w-10 text-teal-600 mx-auto mb-3" />
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <button
                    ...
                    className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-teal-600 text-white font-bold text-xs shadow-md"
                  >
                    Log First Check-in
                  </button>
      ...
      <div className="fixed bottom-20 right-4 z-40">
        <button
          ...
          className="flex items-center gap-1.5 px-4.5 py-3 rounded-full bg-gradient-to-r from-rose-600 to-red-600 text-white font-extrabold text-xs shadow-lg hover:scale-105 transition-all border border-rose-400"
        >
